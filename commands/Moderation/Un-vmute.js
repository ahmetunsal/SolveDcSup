...
exports.run = async(client, message, args) => {
    ...
    message.channel.send(embed.setDescription(`${member} adlı kullanıcı voice mute cezası bitti.`))
    message.guild.channels.cache.get(config.mod.muteLog).send(embed.setDescription(`${message.author} adlı yetkili tarafından ${member} adlı kullanıcının voice mutesi kaldırıldı!`))
    ////////////////////
