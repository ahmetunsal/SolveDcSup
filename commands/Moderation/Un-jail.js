...
exports.run = async(client, message, args) => {
    ...
    message.guild.channels.cache.get(config.mod.jailLog).send(embed.setDescription(`${message.author} adlı yetkili tarafından ${member} adlı kullanıcının jaili kaldırıldı!`))
    ////////////////////
